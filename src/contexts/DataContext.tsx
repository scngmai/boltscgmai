...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const loadMembers = async () => {
    try {
      ...
      if (membersError) {
        console.error('Members loading error:', membersError);
        return;
      }
  ...
  const loadOfficers = async () => {
    try {
      ...
      if (error) {
        console.error('Officers loading error:', error);
        return;
      }
  ...
  const loadMilestones = async () => {
    try {
      ...
      if (error) {
        console.error('Milestones loading error:', error);
        return;
      }
  ...
  const loadBulletinPosts = async () => {
    try {
      ...
      if (error) {
        console.error('Bulletin posts loading error:', error);
        return;
      }
